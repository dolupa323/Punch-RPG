...
local ZONES = {
	...
	CYCLOPS_BAT_ZONE = {
		...
		max = Vector2.new(-585.736, 2729.772),
		spawnPoint = Vector3.new(-744.03, -342.39, 2528.1),
		displayName = "박쥐의 언덕",
		subName = "BAT'S RIDGE",
		priority = 20,
		minLevel = 20,
	...
	SMALL_GOLEM_ZONE = {
		...
		max = Vector2.new(-375.183, 2204.655),
		spawnPoint = Vector3.new(-522.87, -370.514, 2072.01),
		displayName = "스산한 동굴",
		subName = "EERIE CAVE",
		priority = 10,
		minLevel = 15,

...
SkillTreeData.RUNES = {
	...
	},
	{
		...
		name = "짙은 밤",
		type = "ACTIVE",
		icon = "Icon_Skill_Night",
		reqLevel = 1,
		spCost = 0,
		cooldown = 9.0,
		description = "어둠의 기운을 응축해 적에게 날카로운 피해를 입힙니다.",
	...
	},
	{
		...
		reqLevel = 1,
		spCost = 0,
		description = "장착 시 공격 속도가 5% 증가(공격 쿨다운 5% 감소)합니다.",
		effects = { { stat = "COOLDOWN_MULT", value = 0.05 } },
	},
	{
		id = "SKILL_RUNE_STEADFAST",
		name = "부동심",
		type = "PASSIVE",
		icon = "Rune_Steadfast",
		reqLevel = 1,
		spCost = 0,
		description = "장착 시 치명타 확률이 10% 증가합니다.",
	...
	},
	{
		...
		name = "화염",
		type = "ACTIVE",
		icon = "Icon_Skill_FlameAura",
		reqLevel = 1,
		spCost = 0,
		cooldown = 35.0,
		description = "플레이어 주변에 화염을 생성해, 범위 안의 적에게 지속 피해를 줍니다.",
		effects = {},
	},
	{
		id = "SKILL_RUNE_WAVE_ACTIVE",
		name = "파도",
		type = "ACTIVE",
		icon = "Icon_Skill_WaveAura",
		reqLevel = 1,
		spCost = 0,
		cooldown = 35.0,
		description = "플레이어 주변에 파도를 생성해, 범위 안의 적에게 지속 피해를 줍니다.",
		effects = {},
	},
	{
		id = "SKILL_RUNE_SHADOW_ACTIVE",
		name = "그림자",
		type = "ACTIVE",
		icon = "Icon_Skill_ShadowAura",
		reqLevel = 1,
		spCost = 0,
		cooldown = 35.0,
	...
	},
	{
		...
		reqLevel = 1,
		spCost = 0,
		description = "장착 시 대쉬 거리가 증가합니다.",
		effects = { { stat = "DASH_DISTANCE_MULT", value = 1.5 } },
	},
	{
		id = "SKILL_SLIMESHOT",
		name = "슬라임샷",
		type = "ACTIVE",
		icon = "Icon_Skill_SlimeShot",
		reqLevel = 1,
		spCost = 0,
		cooldown = 8.0,
		description = "작은 슬라임을 던져 명중 시 터뜨립니다. 초반에 배우는 만큼 위력은 강하지 않습니다.",
		effects = { { stat = "SKILL_DAMAGE_MULT", value = 0.5 } },
	},
	{
		id = "SKILL_OVERGROWTH",
		name = "오버그로스 버스트",
		type = "ACTIVE",
		icon = "Icon_Skill_OvergrowthBurst",
		reqLevel = 1,
		spCost = 0,
		cooldown = 9.0,
		description = "지면에 마법진을 그려 나무 3그루를 대각선으로 솟아오르게 해 범위 안의 적을 공격합니다.",
		effects = { { stat = "SKILL_DAMAGE_MULT", value = 1.4 } },
	},
	{
		id = "SKILL_MAEHWA",
		name = "매화낙락",
		type = "ACTIVE",
		icon = "Icon_Skill_MaehwaNakrak",
		reqLevel = 1,
		spCost = 0,
		cooldown = 10.0,
		description = "벚꽃 잎이 휘날리는 가운데 분홍빛 검기를 사방으로 흩뿌려 주위의 적을 베어버리는 광역기입니다.",

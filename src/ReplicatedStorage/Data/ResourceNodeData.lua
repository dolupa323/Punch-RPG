...
local ResourceNodeData = {
	...
	},
	{
		...
		optimalTool = nil,
		resources = {
			{ itemId = "MEAT", min = 2, max = 4, weight = 1.0 },
			{ itemId = "TROPICAL_LEATHER", min = 2, max = 3, weight = 0.8 },
			{ itemId = "SHARP_TOOTH", min = 2, max = 2, weight = 0.5 },
		},
		maxHealth = 15,
		respawnTime = 0,
		xpPerHit = 8,

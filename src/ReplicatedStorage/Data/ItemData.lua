...
local ItemData = {
	...
	},
	{
		...
		maxStack = 99,
		weight = 0.1,
		description = "콤프소그나투스의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
		creatureId = "COMPY",
	},
	{
		id = "DODO_DNA",
		...
		maxStack = 99,
		weight = 0.1,
		description = "도도새의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
		creatureId = "DODO",
	},
	{
		...
		maxStack = 99,
		weight = 0.1,
		description = "파라사우롬로푸스의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
		creatureId = "PARASAUR",
	},
	{
		...
		maxStack = 99,
		weight = 0.1,
		description = "트리케라톱스의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
		creatureId = "TRICERATOPS",
	},
	{
		id = "BABY_TRICERATOPS_DNA",
		name = "아기 트리케라톱스 DNA",
		type = "DNA",
		rarity = "RARE",
		maxStack = 99,
		weight = 0.1,
		description = "아기 트리케라톱스의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
		creatureId = "BABY_TRICERATOPS",
	},
	{
		id = "STEGOSAURUS_DNA",
		name = "스테고사우루스 DNA",
		...
		maxStack = 99,
		weight = 0.1,
		description = "스테고사우루스의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
	...
	},
	{
		...
		maxStack = 99,
		weight = 0.1,
		description = "안킬로사우루스의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
	...
	},
	{
		...
		maxStack = 99,
		weight = 0.1,
		description = "랩터의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
		creatureId = "RAPTOR",
	},
	{
		...
		maxStack = 99,
		weight = 0.1,
		description = "티라노사우루스의 유전자 정보가 담긴 신비한 샘플. 사용 시 도감에 등록됩니다.",
		iconName = "DNA_Sample",
		modelName = "DNA_Sample",
		creatureId = "TREX",
	},

...
local ItemData = {
	...
	},
	{
		...
		stackable = true,
		weight = 0.2,
		description = "흡혈 늑대에게서 얻어낸 날카로운 송곳니. 치명적인 무기를 제작하는 데 쓰인다.",
		dropDespawn = "GATHER",
		iconName = "WolfFang",
		modelName = "WolfFang",
	},
	...
	},
	{
		...
		critChance = 0.05,
		slot = "EARRING",
		iconName = "GolemEarring",
		modelId = "GolemEarring",
		description = "빅골렘의 정수가 압축된 전설적인 귀걸이. 무려 100의 체력과 5%의 치명타 확률을 제공합니다.",
	},
	--========================================

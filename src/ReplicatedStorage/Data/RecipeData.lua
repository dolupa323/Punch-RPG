...
local RecipeData = {
	...
	},
	{
		...
		craftTime = 110,
		techLevel = 1,
		inputs = { { itemId = "WOOD_GOLEM_SOUL", count = 100 } },
	...
	},
	{
		...
		craftTime = 100,
		techLevel = 1,
		inputs = { { itemId = "BROKEN_SWORD_FRAGMENT", count = 40 } },
		outputs = { { itemId = "KATANA", count = 1 } },
	},
	{
		id = "CraftIronStaff",
		name = "철검",
		...
		craftTime = 120,
		techLevel = 1,
		inputs = { { itemId = "GOLEM_STONE", count = 40 } },
	...
	},
	{
		...
		craftTime = 75,
		techLevel = 1,
		inputs = { { itemId = "BAT_FANG", count = 30 } },
	...
	},
	{
		...
		craftTime = 140,
		techLevel = 1,
		inputs = { { itemId = "DRAGON_CLAW", count = 20 }, { itemId = "CHILLING_ICE", count = 40 } },
	...
	},
	{
		...
		craftTime = 150,
		techLevel = 1,
		inputs = { { itemId = "GHOST_KNIGHT_SOUL", count = 100 } },
		outputs = { { itemId = "KNIGHT_SWORD", count = 1 } },
	},
	{
		id = "CraftSoulSword",
		name = "소울 소드",
		...
		craftTime = 150,
		techLevel = 1,
		inputs = { { itemId = "GHOST_WIZARD_SOUL", count = 150 } },
		outputs = { { itemId = "SOUL_SWORD", count = 1 } },
	},
	{
		id = "CraftSwordOfJustice",
		name = "저스티스 소드",
		category = "WEAPON",
		requiredFacility = nil,
		craftTime = 200,
		techLevel = 1,
		inputs = { { itemId = "GHOST_GIANT_PRIDE", count = 100 } },
		outputs = { { itemId = "SWORD_OF_JUSTICE", count = 1 } },
	},
	{
		id = "CraftBlueFlameSword",
		name = "블루파이어 소드",
		category = "WEAPON",
		requiredFacility = nil,
		craftTime = 250,
		techLevel = 1,
		inputs = { { itemId = "BLUE_FIRE", count = 100 } },
		outputs = { { itemId = "BLUE_FLAME_SWORD", count = 1 } },
	},
	{
		id = "CraftKrakenSword",
		name = "크라켄 소드",
		...
		craftTime = 280,
		techLevel = 1,
		inputs = { { itemId = "KRAKEN_HEART", count = 30 } },
		outputs = { { itemId = "KRAKEN_SWORD", count = 1 } },
	},
	{
		id = "CraftAbyssSword",
		name = "어비스 소드",
		...
		craftTime = 310,
		techLevel = 1,
		inputs = { { itemId = "ABYSS_GUARDIAN_STONE", count = 40 } },
		outputs = { { itemId = "ABYSS_SWORD", count = 1 } },
	},
	{
		id = "CraftPoseidonSword",
		name = "포세이돈 소드",
		category = "WEAPON",
		requiredFacility = nil,
		craftTime = 340,
		techLevel = 1,
		inputs = { { itemId = "POSEIDON_ESSENCE", count = 50 } },
		outputs = { { itemId = "POSEIDON_SWORD", count = 1 } },
	},
	{

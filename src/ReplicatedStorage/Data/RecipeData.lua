...
local RecipeData = {
	...
	--========================================
	{
		...
		craftTime = 4,
		techLevel = 3,
		inputs = { { itemId = "LOG", count = 1 }, { itemId = "STONE", count = 2 }, { itemId = "FIBER", count = 3 } },
	...
	},
	{
		...
		craftTime = 4,
		techLevel = 3,
		inputs = { { itemId = "LOG", count = 1 }, { itemId = "STONE", count = 3 }, { itemId = "FIBER", count = 3 } },
	...
	},
	{
		...
		craftTime = 5,
		techLevel = 3,
		inputs = { { itemId = "LOG", count = 1 }, { itemId = "BONE", count = 2 }, { itemId = "FIBER", count = 4 } },
	...
	},
	{
		...
		craftTime = 6,
		techLevel = 3,
		inputs = { { itemId = "DURABLE_LEAF", count = 5 }, { itemId = "FIBER", count = 5 } },
...

	{
		...
		craftTime = 5,
		techLevel = 4,
		inputs = { { itemId = "LOG", count = 2 }, { itemId = "FIBER", count = 5 } },
